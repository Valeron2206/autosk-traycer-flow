...
| planning_candidate_keepalive_invalid | freeze_artifact, rebuild_anchor or current publication step according to recorded state | exact candidate keepalive ref/create receipt and complete object closure restored or candidate explicitly superseded; cleanup and publication remain blocked |
