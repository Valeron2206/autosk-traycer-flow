...
| tickets_manifest_invalid | validate_tickets_manifest before freeze; present_tickets_breakdown after publication | post-publication recovery voids old Tickets candidate/receipt/PASS bindings and retains them as audit evidence; corrected manifest/views pass fresh alignment, validation, freeze, full Panel and replacement publication before dispatch_ticket_dag; child/blocker/enrollment side effects remain absent |
| tickets_manifest_stale | validate_tickets_manifest before freeze; present_tickets_breakdown after publication | post-publication recovery voids and retains old Tickets candidate/receipt/PASS records, then runs a new artifact cycle; freeze creates a new immutable receipt bound to the new exact tree and only that receipt becomes current before Panel, replacement publication and dispatch |
