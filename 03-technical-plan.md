...
| publish_artifact_pass | phase=verified, candidate_keepalive phase=verified, planning ref/commit/tree and complete candidate closure exact | exact-old CAS-delete keepalive ref, record release receipt or reconstruct observed-absent release only after the verified planning ref proves the closure, atomically candidate_keepalive phase=released; publish_artifact_pass |
...
| publish_planning_invalidation | phase=verified, candidate_keepalive phase=verified, planning ref and complete invalidation closure exact | exact-old CAS-delete keepalive ref, record/reconstruct release receipt and atomically candidate_keepalive phase=released; publish_planning_invalidation |
