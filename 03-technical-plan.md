...
| publish_artifact_pass | phase=verified, candidate_keepalive phase=verified, planning ref/commit/tree, recorded reflog tail and complete candidate closure exact | under the ref mutex verify the exact recorded planning tail, then one atomic update-ref transaction verifies planning ref=expected commit and deletes candidate_keepalive with snapshot commit expected-old; record tail-bound transaction/release receipt or reconstruct observed-absent release only from the same proofs, atomically candidate_keepalive phase=released; publish_artifact_pass |
...
| publish_planning_invalidation | phase=verified, candidate_keepalive phase=verified, planning ref, recorded reflog tail and complete invalidation closure exact | under the ref mutex verify the exact recorded planning tail, then one atomic update-ref transaction verifies planning ref=expected commit and deletes candidate_keepalive with snapshot commit expected-old; record/reconstruct tail-bound release receipt and atomically candidate_keepalive phase=released; publish_planning_invalidation |
