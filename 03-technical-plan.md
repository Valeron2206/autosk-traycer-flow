...
| init_planning_ref | phase=prepared or phase=ref_created, ref=recorded base and exact operation-specific zero→base reflog entry exists | reconstruct receipt if needed; read-back commit/tree/ref/reflog; atomically phase=verified and planning.init_status=verified/head=base/generation=0; select_next |
