...
replace_once(
    ...
    "escaped Markdown overview rows",
)
...
replace_once(
    ...
    "renderer and malformed-input contract",
)
...
print("Applied final handoff hardening for malformed shapes, case aliases and Markdown structure.")
