...
replace_once(
    ...
    '''The renderer normalizes headings to one line and escapes Markdown table delimiters so manifest strings cannot forge overview columns.''',
    '''The renderer normalizes headings and body-rendered goal fields to one line and escapes Markdown table delimiters so manifest strings cannot forge headings, sections or overview columns.''',
