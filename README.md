...
1. Если Brief, Core Flow, Tech Plan, Tickets или другой behavior-defining документ создан/изменён, панель обязательна. До generic registry из issue #14 иной normative artifact fail-closed классифицируется в один из четырёх named lifecycles; если однозначной классификации нет, panel/PASS запрещены.
...
13. Модель не подтверждает собственное материальное решение. Brief/Core Flow/Tech Plan/Tickets use canonical material manifest. Любой иной normative artifact до issue #14 обязан fail-closed войти в подходящий named lifecycle; unknown mapping blocks draft/panel/PASS.
